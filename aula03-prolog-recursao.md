...
date:   2016-07-20 16:40:00 -0300
categories: aula
---

## Informes

- Evento: [Semana de Engenharia de Computação e Tecnologia (SECOMTEC)](http://secomtec.ml/)
- Evento: [NorDevs Game Jam](http://indigente.ufba.br/eventos) - inscrições só até hoje!
- Ponto extra para quem resolver o [problema das 3 casas](https://rachacuca.com.br/logica/problemas/1/) usando Prolog até a aula do dia 27 de julho

## Revisão

Resolução de exercícios selecionados da aula passada: 12, 17 e outros conforme solicitação.

Predicado `distinct/1` para ocultar resultados duplicados.
